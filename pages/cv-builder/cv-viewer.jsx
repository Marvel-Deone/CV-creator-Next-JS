                ...
                <div className='flex print:gap-5 print:mx-0 mx-auto'>
                    <div className='print:bg-blue-400 bg-[#496267] text-white px-4 w-40 py-6 h-auto'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <h2 className='text-[12px] mt-2'>CONTACT</h2>
                            <div className='flex flex-col gap-2'>
                                <div className='flex flex-col gap-3'>
                                    <div className='flex gap-6'>
                                        ...
                                        {userCvInfo && (<span className='text-[11px]'>{userCvInfo.contactInfo.city} {userCvInfo.contactInfo.state} {userCvInfo.contactInfo.zipCode}</span>)}
                                    </div>
                                </div>
                                <div className='flex flex-col gap-3'>
                                    <div className='flex gap-6'>
                                        ...
                                        {userCvInfo && (<span className='text-[11px]'>{userCvInfo.contactInfo.phoneNumber}</span>)}
                                    </div>
                                </div>
                                <div className='flex flex-col gap-3'>
                                    <div className='flex gap-6'>
                                        ...
                                        {userCvInfo && <span className='text-[11px]'>{userCvInfo.contactInfo.email}</span>}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <h2 className='text-xs mt-2'>SKILLS</h2>
                            <ul className='text-[11px] list-disc px-4 py-3'>
                                {skillsInfo && skillsInfo.map(skill => {
                                    return (
                                        <li key={skill.skillId}>{skill.skill}</li>
                                    )
                                })
                                }
                    ...
                    <div className='bg-white print:w-full w-80 px-3 py-6 text-[#496267] print:text-3xl'>
                        <div className='flex flex-col gap-4'>
                            <div className='flex flex-col gap-2'>
                                {userCvInfo && <h2 className='text-2xl text-[#496267]'>{userCvInfo.contactInfo.firstname} {userCvInfo.contactInfo.lastname}</h2>}
                                <div className='flex gap-2 items-center'>
                                    {userCvInfo && <p className='text-[#496267] text-[11px] font-semibold text-center'>{userCvInfo.contactInfo.jobTitle}</p>}
                                    <hr className='border bg-[#496267] w-44 h-3' />
                                </div>
                            </div>
                            <div className='flex flex-col gap-1'>
                                <h2 className='underline text-sm font-semibold'>CAREER OBJECTIVE</h2>
                                {careerNote && careerNote.map(carrer => {
                                    return (
                                        <span className='print:text-sm text-[10px]'>{carrer}</span>
                                    )
                                })
                                }
                            </div>
